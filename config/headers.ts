...
export const cspHeaders = {
  'Content-Security-Policy': [
    ...
    `script-src 'self' 'unsafe-inline' 'sha-256-a8370c36478d3b76039efb53600b8ba7dfb5c0603371c6d9207557573933bc33' ${turnstileEnabled ? 'https://challenges.cloudflare.com' : ''}`.trim(),
