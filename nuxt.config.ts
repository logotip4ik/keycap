  ...
  routeRules: {
    '/**': {
      headers: {
        ...
        'Content-Security-Policy': 'default-src \'self\'; img-src \'*\'; connect-src \'*\'; media-src \'*\'; script-src \'unsafe-inline\'; script-src-elem \'unsafe-inline\'; style-src \'unsafe-inline\'; upgrade-insecure-requests',
      },
    },
    '/about': { static: true },
