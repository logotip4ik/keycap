  ...
  routeRules: {
    '/**': {
      headers: {
        ...
        'Content-Security-Policy': 'default-src \'self\'; script-src \'unsafe-inline\' \'self\'; script-src-elem \'unsafe-inline\' \'self\'; style-src \'unsafe-inline\' \'self\'; upgrade-insecure-requests',
      },
    },
    '/about': { static: true },
